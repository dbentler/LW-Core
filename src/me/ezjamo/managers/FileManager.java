...
import me.ezjamo.utils.DiscUtil;
...
public class FileManager {
    ...
    public FileManager(Lonewolves p) {
        this.p = p;
    }
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        ...
        if (loaded == null) {
            p.getLogger().log(Level.WARNING, "Using default as I failed to load: " + file);
            ...
            p.getLogger().log(Level.WARNING, "Backing up copy of bad file to: " + backup);
    ...
    public boolean save(Object instance, File file) {
        return DiscUtil.writeCatch(file, gson.toJson(instance), false);
    }
    ...
    public <T> T load(Class<T> clazz, File file) {
        ...
        try {
            ...
            p.getLogger().log(Level.WARNING, ex.getMessage());
        }
